...
![image](https://github.com/KOCOKERZ/WS/blob/main/ChapterQUIS/1214085_Fitrah_Quiz/Foto/Hasil%20JS%20Console.jpg?raw=true)
3. Pada gambar diatas telah dilakukan test API dimana data telah ditampilkkan pada consol diatas dengan menggunakan api dan Ketia dicoba dengan menggunaan postman muncul tampilan seperti berikut:
![image](https://github.com/KOCOKERZ/WS/blob/main/ChapterQUIS/1214085_Fitrah_Quiz/Foto/Postman.jpg?raw=true)
4. Tampilan frontend yang mana pada saat tombol register ditekan maka method post akan dijalankan sehingga test post api tersebut dapat dilihat di pipe dream dengan tampilan seperti berikut:
![image](https://github.com/KOCOKERZ/WS/blob/main/ChapterQUIS/1214085_Fitrah_Quiz/Foto/FrontEnd%20Pipedream.jpg?raw=true)
![image](https://github.com/KOCOKERZ/WS/blob/main/ChapterQUIS/1214085_Fitrah_Quiz/Foto/Pipedream.jpg?raw=true)
5. Buatlah database menggunakan mongodb yang kemudian di koneksikan ke mongodb compass
![image](https://github.com/KOCOKERZ/WS/blob/main/ChapterQUIS/1214085_Fitrah_Quiz/Foto/MongoDB%20Compass.jpg?raw=true)
6. Buatlah Struct, Package, Testing dan publish package mengakses database yang telah dibuat. File telah dibuat dengan ekstensi .go dengan nama file type.go, fitrah.go, dan fitrah_test.go setelah membuat seluruh file diatas, lakukan inisialisasi package dengan menjalankan perintah berikut di terminal
```sh
go mod init github.com/kerjabhakti/WS/Chapter03/coba
```
7. Maka akan muncul file go.mod pada lokasi filenya, setelah itu isikan 3 file tersebut dengan source code yang dibutuhkan. kemudian lakukan kompilasi depedensi dengan menggunakan :
```sh
go mod tidy
```
8. Setelah melakukan kompilasi depedensi maka akan muncul file go.sum. Kemudian lakukan testing dengan menggunakan perintah
```sh
go test
```
9. Berikut merupakan hasilnya
![image](https://github.com/KOCOKERZ/WS/blob/main/ChapterQUIS/1214085_Fitrah_Quiz/Foto/Go%20Test%20Hasil.jpg?raw=true)

#SOURCE CODE
1. Index.html
```go
<!DOCTYPE html>
<!-- This site was created in Webflow. https://www.webflow.com --><!-- Last Published: Thu Mar 16 2023 08:49:55 GMT+0000 (Coordinated Universal Time) -->
<html
  data-wf-domain="fitrah-akbars-site.webflow.io"
  data-wf-page="6412d7426c8acea2670813d9"
  data-wf-site="6412d7426c8ace49320813d8"
>
  <head>
    <meta charset="utf-8" />
    <title>Fitrah Akbar&#x27;s Site</title>
    <meta content="width=device-width, initial-scale=1" name="viewport" />
    <meta content="Webflow" name="generator" />
    <link
      href="https://uploads-ssl.webflow.com/6412d7426c8ace49320813d8/css/fitrah-akbars-site.webflow.777c8f605.css"
      rel="stylesheet"
      type="text/css"
    />
    <!--[if lt IE 9
  ...
  <body>
      ...
      <div class="container">
        <div class="footer-wrapper">
          ...
          <div class="footer-content">
            <div
              id="w-node-_3eedba38-b345-859c-7934-e7f467d586ba-670813d9"
              class="footer-block"
            >
            ...
            <div
              id="w-node-_3eedba38-b345-859c-7934-e7f467d586c3-670813d9"
              class="footer-block"
            >
            ...
            <div
              id="w-node-_3eedba38-b345-859c-7934-e7f467d586ce-670813d9"
              class="footer-block"
            >
    ...
    <script
      src="https://d3e54v103j8qbb.cloudfront.net/js/jquery-3.5.1.min.dc5e7f18c8.js?site=6412d7426c8ace49320813d8"
      type="text/javascript"
      integrity="sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0="
      crossorigin="anonymous"
    ></script>
    <script
      src="https://uploads-ssl.webflow.com/6412d7426c8ace49320813d8/js/webflow.959d35e1a.js"
      type="text/javascript"
    ></script>
                    ...
                    <div class="flex -mx-3">
                        <div class="w-1/2 px-3 mb-5">
                            ...
                            <div class="flex">
                                ...
                                <input id="namadepan" type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Akbar Tampan">
                            </div>
                        </div>
                        <div class="w-1/2 px-3 mb-5">
                            ...
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                <input id="namabelakang" type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Banget">
                            </div>
                        </div>
                    </div>
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            ...
                            <div class="flex">
                                ...
                                <input id="email" type="email" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="AkbarTampan@Banget.com">
                            </div>
                        </div>
                    </div>
                    <div class="flex -mx-3">
...
function PostSignUp(namadepan,namabelakang,email,password){
    ...
    fetch("https://eowsxkms2wp32qy.m.pipedream.net", requestOptions)
        .then(response => response.text())
        .then(result => console.log(result))
        .catch(error => console.log('error', error));
}
