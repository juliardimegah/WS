...
# Membuat tampilan Front-End dengan Tailwind
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <input id="email" type="email" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="maulana@gmail.com">
                                </div>
                            </div>
                        </div>
                        <div class="flex -mx-3">
...
![image](https://github.com/kerjabhakti/WS/blob/main/ChapterQUIS/1214078_Maulana_QUIS/foto/tampilan%20index.html.png?raw=true)


# Buat file javascript main.js yang dihubungkan dengan index.html
...
function PostSignUp(namadepan,namabelakang,email,password){
 ...
 masukan code pada bagian bawah file main.js untuk memunculkan console.log:
 
 ![image](https://github.com/kerjabhakti/WS/blob/main/ChapterQUIS/1214078_Maulana_QUIS/foto/8.%20tambahkan%20console.log(result).png?raw=true)
 
 ```sh
 console.log(result)
 ```
 
 Dapat di lihat di inspect :
 
 ![image](https://github.com/kerjabhakti/WS/blob/main/ChapterQUIS/1214078_Maulana_QUIS/foto/7.%20console%20log%20js.png?raw=true)
...
![image](https://github.com/kerjabhakti/WS/blob/main/ChapterQUIS/1214078_Maulana_QUIS/foto/type.go%20buat%20struct.png?raw=true)
...
func InsertPresensi(long float64, lat float64, lokasi string, phonenumber string, checkin string, biodata Karyawan) (InsertedID interface{}) {
	...
	return InsertOneDoc("ChapterQUIS", "MaulanaQUIS", presensi)
}
