# UTS Pemrograman III (Web Services)

PROCESS

1. Pertama yaitu membuat Frontend untuk menampilkan Public API (HTML & JS)
...
<div class="container mx-auto mt-8">
  <div class="bg-white rounded-lg shadow overflow-hidden">
    <div class="px-6 py-4">
      <h2 class="font-bold text-xl mb-2">Daftar Kodepos</h2>
        ...
        <div class="flex flex-wrap -mx-2">
          <div class="w-full px-2">
            <table class="w-full">
              <thead>
                <tr>
                  <th class="font-bold text-left">Kecamatan</th>
                  <th class="font-bold text-left">Kelurahan</th>
                  <th class="font-bold text-left">Kodepos</th>
                </tr>
              </thead>
              <tbody id="table-body">
              </tbody>
